...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mlmillion-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mlmillion-chef"
  #   chef.validation_client_name = "mlmillion-chef-validator"
  #   chef.validation_key_path = ".chef/mlmillion-chef-validator.pem"
  # end
end
